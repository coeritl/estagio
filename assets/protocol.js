...
form.addEventListener('submit', async event => {
  ...
  try {
    ...
    const defaultNotes = {
      ...
      tce_gerado: 'O documento foi gerado. O Autentique enviará os links individuais de assinatura aos endereços de e-mail informados no preenchimento da solicitação do TCE. Cada signatário deve conferir o próprio e-mail, inclusive as pastas de spam e lixo eletrônico.',
