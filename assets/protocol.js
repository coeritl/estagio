...
form.addEventListener('submit', async event => {
  ...
  try {
    ...
    const defaultNotes = {
      ...
      tce_gerado: 'O documento foi gerado. O Autentique enviará os links individuais pelos canais escolhidos pela COERI (e-mail ou WhatsApp). Confira suas mensagens e, no caso do e-mail, também as pastas de spam e lixo eletrônico.',
